...
\subsubsection{Validation du NAT}
...
\begin{itemize}
	...
	\begin{itemize}
		\item VLAN\_10 $\rightarrow$ VLAN\_31
		\item VLAN\_20 $\rightarrow$ VLAN\_31
		\item VLAN\_32 $\leftrightarrow$ tous (interne + Internet)
...
\begin{itemize}
	...
	\item \textbf{VLAN\_32 :} accessible depuis tous les VLANs et depuis Internet
\end{itemize}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{../captures/09_ACL_ping_filtre_VLAN1020.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{../captures/09_ACL_ping_filtre_VLAN3132.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{../captures/09_ACL_wireshark_VLAN3132.png}
